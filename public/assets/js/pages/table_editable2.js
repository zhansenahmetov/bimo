$(function () {
    ...
    function editableTable() {
        ...
        function addRow(oTable, nRow) {
            ...
            jqTds[1].innerHTML = '<input type="text" id="brand" class="form-control small" value="' + aData[1] + '">';
            jqTds[2].innerHTML = '<input type="number" id="manufac_price" class="form-control small" value="' + aData[2] + '">';
            jqTds[3].innerHTML = '<input type="number" id="kaspi_price" class="form-control small" value="' + aData[3] + '">';
            jqTds[4].innerHTML = '<input type="number" id="manufactorId" class="form-control small" value="' + aData[4] + '">';
        ...
        function editRow(oTable, nRow) {
            ...
            var aData = oTable.fnGetData(nRow);
            var jqTds = $('>td', nRow);
            jqTds[0].innerHTML = '<input type="text" id="name" class="form-control small" value="' + aData[0] + ' "disabled>';
            jqTds[1].innerHTML = '<input type="text" id="brand" class="form-control small" value="' + aData[1] + '">';
            jqTds[2].innerHTML = '<input type="number" id="manufac_price" class="form-control small" value="' + aData[2] + '">';
            jqTds[3].innerHTML = '<input type="number" id="kaspi_price" class="form-control small" value="' + aData[3] + '">';
            jqTds[4].innerHTML = '<input type="number" id="manufactorId" class="form-control small" value="' + aData[4] + '">';
        ...
        function saveRow(oTable, nRow) {
            ...
            var brand = jqInputs[1].value;
            var manufac_price = jqInputs[2].value;
            var kaspi_price = jqInputs[3].value;
            var manufactorId = jqInputs[4].value;
            ...
            $.ajax({
                    ...
                    data: {
                         name: name,
                         brand: brand,
                         manufac_price: manufac_price,
                         kaspi_price: kaspi_price,
        ...
        $('.dataTables_filter input').attr("placeholder", "Поиск поставщиков..");
