...
Route::middleware(['admin'])->prefix('admin')->group(function (){
    ...
    Route::post('/product/update', [AdminController::class, 'update_product'])->name('update_product_admin');
    Route::post('/product/delete',[AdminController::class, 'delete_product'])->name('delete_product_admin');
